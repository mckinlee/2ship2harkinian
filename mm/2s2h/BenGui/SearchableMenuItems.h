        ...
        { "Gameplay",
          ...
          { {
                ...
                { "Swordsman School Finish Early", "gEnhancements.Minigames.SwordsmanSchool.FinishEarly",
                  ...
                  WIDGET_CVAR_CHECKBOX },
                { "Swordsman School Winning Score", "gEnhancements.Minigames.SwordsmanSchool.WinningScore",
                  "Sets the score required to win the Swordsman School.", WIDGET_CVAR_CHECKBOX },
                { "Two-Handed Sword Spin Attack",
                  "gEnhancements.Equipment.TwoHandedSwordSpinAttack",
